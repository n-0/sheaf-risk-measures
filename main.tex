...
\newcommand{\stdaff}{\mathbb{A}^{n}_{\mathbb{K}}}
\newcommand{\stdpolyr}{\mathbb{K}[\mathbf{X}]}
...
\title{Sheaves Of Risk Measure Lattices}
...
\input{lattice_riskm}
\input{ideal_filter_risk}
\input{quotient_lattice}
\input{sheaf_risk_measure}
\end{section}
\newpage
\appendix
\begin{section}{Appendix A}
  %\input{lattice_topology}
  %\input{appendix1}
  \input{colimit_lattice}
\end{section}
